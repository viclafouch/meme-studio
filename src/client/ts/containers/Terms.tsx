      ...
      <div className="content-one">
        <section className="terms-body container">
          ...
          <ul>
            ...
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Meme
              Studio.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Meme Studio, accessible from https://www.meme-studio.io
            </li>{' '}
            <li>
          ...
          <h2>Media</h2>
          <p>
            By uploading any type of media or other content (including but not limited to images, video, and audio) on the
            Website, you are agreeing that (i) doing so does not violate or infringe anyone else’s rights, and (ii) you have the
            rights to use whatever content you are uploading or requesting, and that you have the rights to modify that content in
            whichever ways you decide to modify it while using The Service.
          </p>
          ...
          <p>
            ...
            hardware used with the Service, or otherwise in connection with any provision of this Terms), even if the Company or
          ...
          <h3>Waiver</h3>
          <p>
            Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms
